...
if (isset($_POST['submit'])) {
    ...
    if ($thucthi) {
        insert_table($name,$amount);
        $messenger = "Bạn Đã tạo bàn thành công";
        unset($name,$amount);
    }
...
<form action="index.php?act=addtable"   method="post">
            ...
            <input class=" mt-5 text-xl p-3 mb-[15px] w-[150px] text-white bg-blue-500 rounded-2xl delay-100 hover:bg-blue-600" type="submit" name="submit" value="Tạo Mới">
</form>
<a class=" mt-5 text-xl p-4 mb-[15px] w-[150px] text-white bg-yellow-500 rounded-2xl delay-100 hover:bg-yellow-600" href="index.php?act=table"><button>Danh Sách bàn</button></a>